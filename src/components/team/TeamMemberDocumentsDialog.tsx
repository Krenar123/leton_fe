...
interface TeamMemberDocumentsDialogProps {
  isOpen: boolean;
...
const quickAccessFolders: QuickAccessFolder[] = [
  { id: "home", name: "Member Home", icon: Home, folderId: null },
  { id: "contracts", name: "HR Documents", icon: Folder, folderId: 2 },
  { id: "training", name: "Training", icon: Folder, folderId: 1 },
];
...
const initialMockDocuments: DocumentItem[] = [
  ...
  {
    id: 4,
    name: "Performance Review Q3.docx",
    type: "file",
    size: 850000,
...
export const TeamMemberDocumentsDialog = ({ 
  isOpen, 
  onOpenChange, 
  memberName 
}: TeamMemberDocumentsDialogProps) => {
          ...
          <div className="flex-1 flex flex-col min-w-0">
            <DialogHeader className="p-6 pb-4 border-b">
              <DialogTitle className="flex items-center justify-between">
                <span>Documents - {memberName}</span>
              </DialogTitle>
            </DialogHeader>
