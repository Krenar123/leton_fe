      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-slate-50">
            ...
            {projectColumns.status && <TableHead className="font-semibold text-sm w-[100px]">Status</TableHead>}
          </TableRow>
        </TableHeader>
        <TableBody>
          {projects
            ...
            .map((project) => (
            <TableRow key={project.id} className="hover:bg-slate-50 cursor-pointer transition-colors">
              <TableCell className="font-medium text-blue-600 hover:text-blue-800 cursor-pointer text-sm">
                {project.name}
              </TableCell>
              ...
              {projectColumns.value && <TableCell className="font-medium text-sm text-right">{formatCurrency(project.value)}</TableCell>}
