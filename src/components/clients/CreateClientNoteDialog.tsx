...
interface CreateClientNoteDialogProps {
  onCreateNote: (note: Omit<ClientNote, 'id' | 'createdAt' | 'updatedAt'>) => void;
  onClose: () => void;
  existingCategories: string[];
}

export const CreateClientNoteDialog = ({ onCreateNote, onClose, existingCategories }: CreateClientNoteDialogProps) => {
