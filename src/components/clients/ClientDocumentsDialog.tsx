...
const quickAccessFolders: QuickAccessFolder[] = [
  { id: "home", name: "Client Home", icon: Home, folderId: null },
  { id: "contracts", name: "Contracts", icon: Folder, folderId: 2 },
  { id: "correspondence", name: "Correspondence", icon: Folder, folderId: 1 },
];
...
export const ClientDocumentsDialog = ({ clientName, onClose }: ClientDocumentsDialogProps) => {
