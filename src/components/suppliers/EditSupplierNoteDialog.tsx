...
interface EditSupplierNoteDialogProps {
  note: SupplierNote;
  onEditNote: (note: Omit<SupplierNote, 'id' | 'createdAt' | 'updatedAt'>) => void;
  onClose: () => void;
  existingCategories: string[];
}

export const EditSupplierNoteDialog = ({ 
  note, 
  onEditNote, 
  onClose, 
  existingCategories 
}: EditSupplierNoteDialogProps) => {
