    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      >
        <div className="text-center">
          <div className="text-3xl font-bold mb-1" style={{ color: '#0a1f44' }}>{totalSuppliers}</div>
      ...
      >
        <div className="text-center">
          <div className="text-3xl font-bold mb-1" style={{ color: '#0a1f44' }}>{activeSuppliers}</div>
      ...
      <Card className="p-6 bg-slate-400">
        <div className="space-y-2">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="text-white font-bold text-lg">{formatCurrency(totalOutstanding)}</span>
          </div>
        </div>
      </Card>
    </div>
